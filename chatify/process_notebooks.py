...
def get_tutorial_notebooks(basedir):
    return lsdir(os.path.join(basedir, 'tutorials', 'W*D*_*', 'student', 'W*D*_Tutorial*.ipynb')) + \
           lsdir(os.path.join(basedir, 'tutorials', 'W*D*_*', 'instructor', 'W*D*_Tutorial*.ipynb'))
